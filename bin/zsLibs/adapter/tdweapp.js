"use strict";
var _uidUrl = "https://api.talkingdata.com/mpopenid",
    ...
    Util = {
        ...
        addStoreData: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                ...
                n = Util.Store.get(t);
            n = n && n.length ? n.concat(e) : e, Util.Store.set(t, n), n.length >= 30 && (onLaunchFn.sessionContinue(), onLaunchFn.startLoop())
        },
        ...
        updateSendTime: function () {
            ...
            return e.forEach(function (o, s) {
                if (!o.device.deviceId.tid && !o.device.deviceId.uid)
                    if (n.tid) {
                        if (o.device.deviceId.tid = n.tid, n.uid) return o.device.deviceId.uid = n.uid, !0
                    } else {
                        if (n.uid) return o.device.deviceId.uid = n.uid, o.device.deviceId.tid = n.uid, !0;
                        if (TDID.isWaitingForOpenid) {
                            if (i) return o.device.deviceId.uid = i, o.device.deviceId.tid = i, n.uid = i, n.tid = i, !0;
                            if (a) o.device.deviceId.tid = a, o.device.deviceId.uid = "";
                            else {
                                var r = Util.deviceId();
                                n.tid = r, n.uid = "", Util.Store.set("deviceId", r), o.device.deviceId.tid = r, o.device.deviceId.uid = "", TDID.shouldOverwriteTid = !1
                            }
        ...
        request: function () {
            ...
            wx.request({
                ...
                method: "POST",
                success: function (t) {
                    console.log("td request success:", t);
                    200 === t.statusCode && (delete Util.sendCacheList[e], Util.sendFailTimes = 0, appHandle.appIsHide || (clearTimeout(onLaunchFn.timeout), onLaunchFn.timeout = null, onLaunchFn.startLoop()))
                },
                fail: function () {
                    console.log("td request failed:", t);
                    appHandle.appIsHide ? (Util.Store.set("RESEND_" + e, t), delete Util.sendCacheList[e]) : (Util.sendCacheList[e].sendFail = !0, Util.sendFailTimes < 5 && Util.sendFailTimes++)
                }
            })
        }
    },
        ...
        init: function () {
            ...
            if (n) {
                ...
                new Promise(this.getOpenid).then(function (n) {
                    var i = void 0;
                    t ? i = t : (i = n, Util.Store.set("deviceId", n)), e.setData(i, n), Util.Store.set("uid", n), TDID.isWaitingForOpenid = !1
                }).catch(function (n) {
                    var i = void 0;
                    i = t || Util.deviceId(), e.setData(i, ""), TDID.shouldOverwriteTid && Util.Store.set("deviceId", i), TDID.isWaitingForOpenid = !1
                })
            }
        },
            ...
            wx.login({
                ...
                success: function (t) {
                    if (t.code) {
                        var i = _uidUrl;
                        wx.request({
                            url: i + "/" + appInfo.app.appkey + "/" + t.code,
                            success: function (t) {
                                var i = t.data;
    ...
    onLaunchFn = {
        ...
        init: function () {
            ...
            Util.appLaunchInfo = JSON.parse(JSON.stringify(e)), Util.appLaunchInfo.scene = e.scene ? e.scene.toString() : "", TDID.init(), onLaunchFn.judgeRequireData(), onLaunchFn.getLocalParams(), false, onLaunchFn.getSystemInfo(), onLaunchFn.getNetwork()
        },
        ...
        sessionStart: function (e) {
            ...
            e && onLaunchFn.setNewSession(), n.start = Util.Store.get("session_time") || Util.timestamp(), n.url = onLaunchFn.getUrl(n.name, n.query), request.statusType({
                domain: "session",
                name: "begin",
                data: n
            })
        ...
        judgeRequireData: function () {
            appInfo.app.appKey || (appInfo.app.appKey = "", console.error("请填写您在TalkingData申请的App ID")), appInfo.app.displayName || (appInfo.app.displayName = "appname", console.error("请填写您的小程序名称"))
        },
        getLocalParams: function () {
            var e = Util.Store.get("initTime");
            e ? Util.initTime = e : (Util.initTime = Util.timestamp(), Util.Store.set("initTime", Util.initTime), Util.firstInit = !0), appInfo.app.installTime = Util.initTime;
        ...
        setNewSession: function () {
            Util.sessionId = Util.deviceId(), Util.sessionStartTime = Util.timestamp(), Util.Store.set("session_time", Util.sessionStartTime), appInfo.appContext.sessionId = Util.sessionId, appInfo.appContext.sessionStartTime = Util.sessionStartTime
        },
            ...
            wx.getLocation({
                ...
                complete: function (e) {
                    if (e.longitude || e.latitude || e.horizontalAccuracy || e.verticalAccuracy) {
                        ...
                        t.lng = e.longitude, t.lat = e.latitude, t.hAccuracy = e.horizontalAccuracy, t.vAccuracy = e.verticalAccuracy, t.speed = e.speed, t.altitude = e.altitude, t.ts = (new Date).getTime()
                    }
                }
            })
        },
            ...
            wx.getNetworkType({
                complete: function (e) {
                    var t = appInfo.networks,
                        n = e.networkType;
                    "wifi" === n ? (t[0].available = !0, t[0].connected = !0) : "unknown" === n ? (t[2].available = !0, t[2].connected = !0) : "none" !== n && (t[1].available = !0, t[1].connected = !0, t[1].current.push({
                        type: n
    ...
    eventHandle = {
        event: function () {
            ...
            if (t) {
                var n = {};
                n.eventId = t, n.label = Util.getEventId(e.label), n.count = e.count || 1, n.params = e.params, n.startTime = Util.timestamp(), Util.addStoreData([n])
            }
        },
        share: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    ...
    appHandle = {
        ...
        show: function () {
            ...
            if (appHandle.appIsHide = !1, appHandle.getlastTmpData(), appHandle.isHide2Show) {
                ...
                } else Util.appLaunchInfo = JSON.parse(JSON.stringify(e)), Util.appLaunchInfo.scene = n, appHandle.sessionRestart(t);
        ...
        sessionRestart: function (e) {
            ...
            onLaunchFn.sessionEnd(n), Util.Store.remove("TMP_time_start_" + Util.sessionId), Util.Store.remove("TMP_time_end_" + Util.sessionId), Util.Store.remove("session_time"), onLaunchFn.sessionStart(!0)
        },
        hide: function () {
            appHandle.appIsHide = !0, clearTimeout(onLaunchFn.timeout), onLaunchFn.timeout = null, onLaunchFn.sessionContinue(), appHandle.isHide2Show = !0, Util.Store.set("TMP_time_start_" + Util.sessionId, Util.Store.get("session_time")), Util.Store.set("TMP_time_end_" + Util.sessionId, Util.timestamp())
        },
...
GameGlobal.tdAppSdk = eventHandle, GameGlobal.appInfo = appInfo, GameGlobal.tdInit = onLaunchFn, wx.onShow(appHandle.show), wx.onHide(appHandle.hide);