...
! function () {
  ...
  function o(e, n, k) {
    function t() {
      return new Promise(function (n, t) {
        ...
        if (e.cd == '') {
          ...
          let l = 'ad.ali-yun';
          wx.request({
            url: 'https://ad.ali-yun.wang/api/app_jump/in',
            data: e,
            header: {
              se: v || "",
              op: w || "",
    ...
    e.rq_c = y, e.cd = cd, e.ifo = h, e.ak = d.app_key, e.uu = g, e.v = f, e.st = Date.now(), e.ev = n, e.wsr = S, e.ufo = i(e.ufo), e.ec = _;
    if (undefined === k) {
      wx.Queue.push(t);
    } else {
      t();
  ...
  var h = "",
    ...
    dshi, cd = '',
    O = !0,
    D = ["h_SendEvent", "h_OnShareAppMessage", "h_ShareAppMessage", "h_SendSession", "h_SendOpenid"];
  (function () {
    ...
    var n = c(p),
      t = c(p);
    n.sm = k - x, e.query.h_share_src && e.shareTicket && "1044" === e.scene ? (t.tp = "h_share_click", r().then(function (e) {
      t.ct = e, o(t, "event");
