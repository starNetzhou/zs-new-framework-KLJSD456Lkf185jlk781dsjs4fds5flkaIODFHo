...
import FGUI_full_2 from "./FGUI_full_2";
import FGUI_item_4 from "./FGUI_item_4";
import FGUI_icon_4 from "./FGUI_icon_4";
import FGUI_item_5 from "./FGUI_item_5";
...
import FGUI_fake_msg from "./FGUI_fake_msg";
import FGUI_friend_challenge from "./FGUI_friend_challenge";
import FGUI_knock_export from "./FGUI_knock_export";
...
import FGUI_item_9 from "./FGUI_item_9";
...
export default class exportBinder {
	public static bindAll():void {
		...
		fgui.UIObjectFactory.setExtension(FGUI_item_9.URL, FGUI_item_9);
	}
}